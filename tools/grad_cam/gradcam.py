...
class CamExtractor():
    ...
    def forward_pass_on_convolutions(self, x):
        ...
        for module_pos, module in self.model.module.rpn.backbone_net.Img_Block._modules.items():
            x = module(x)  # Forward
    ...
    def forward_pass(self, x):
        ...
        conv_output, x = self.forward_pass_on_convolutions(x.cuda())
...
class GradCam():
    ...
    def generate_cam(self, input_image, target_class=None):
        ...
        self.model.module.rpn.backbone_net.Img_Block.zero_grad()
        self.model.module.rpn.backbone_net.Img_Block._modules.items()
        # Backward pass with specified target
        model_output.cpu().backward(gradient=one_hot_output, retain_graph=True)
...
if __name__ == '__main__':
    ...
    example_list = (('../../data/KITTI/object/training/image_2/000002.png', None),)
    ...
    pretrained_model.module.load_state_dict(checkpoint['model_state'])
